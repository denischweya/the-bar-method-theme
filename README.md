...
Please see the [design specification](https://github.com/WordPress/thebarmethod/blob/trunk/DESIGN-SPEC.md) for more information about the default typography and spacing settings.

## Contributing

If you would like to contribute code, the list of [open issues](https://github.com/WordPress/thebarmethod/issues) is a great place to start looking for tasks. [Pull requests](https://github.com/WordPress/thebarmethod/pulls) are preferred when linked to an existing issue.

Contributing is not just for developers! There are many opportunities to help with [testing](#getting-started), triage, discussion, designing and building variations, and more. Please look through [open issues](https://github.com/WordPress/thebarmethod/issues), and join in wherever you feel most comfortable.
